...
public class SportsSpaceAvailibilty extends Fragment {
    RadioGroup yesorno;
    RadioButton yes,no;
    Button nextBTn;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view=inflater.inflate(R.layout.sports_space_availibilty,container,false);
        ...
        nextBTn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sportsSpaceAvail=checkedBtn.getText().toString();
                SharedPreferences pref = getActivity().getPreferences(Context.MODE_PRIVATE);
                SharedPreferences.Editor edt = pref.edit();
                edt.putString("sportsSpaceAvail",sportsSpaceAvail);
                edt.commit();
            }
        });
        return view;
