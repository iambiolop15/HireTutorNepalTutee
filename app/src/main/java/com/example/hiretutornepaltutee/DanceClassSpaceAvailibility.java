...
public class DanceClassSpaceAvailibility extends Fragment {
    RadioGroup yesorno;
    RadioButton yes,no;
    Button nextBTn;
    @Nullable
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view=inflater.inflate(R.layout.dance_class_space_availability,container,false);
        ...
        nextBTn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String danceSpacAvail=checkedBtn.getText().toString();
                SharedPreferences pref = getActivity().getPreferences(Context.MODE_PRIVATE);
                SharedPreferences.Editor edt = pref.edit();
                edt.putString("danceSpacAvail",danceSpacAvail);
                edt.commit();
            }
        });
